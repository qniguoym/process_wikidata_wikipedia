...
def unescape(text):
    ...
    :return The plain text, as a str string, if necessary.
    """
...
# \p{Zs} is str 'separator, space' category. It covers the space 0x20
...
def main():
    ...
    parser.add_argument("--input",
                        ...
                        default='./data/arwiki-20210301-pages-articles-multistream.xml.bz2')
    ...
    groupP.add_argument("-l", "--links", action="store_false",
                        help="preserve links")
